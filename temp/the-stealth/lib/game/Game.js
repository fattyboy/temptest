...
Game.prototype={
	...
	load : function(force){
		...
		if (this.loader!=null){
			var resCache=this.loader.load(resList, 
				ns.delegate(this._onLoad,this), 
				ns.delegate(this._onLoading,this) );
	...
	ready : function(){
		...
		this.pos=ns.getDomOffset(this.container);
